const Footer = () => {
    return (
        <footer className="footer mt-auto" style={{position:'sticky',bottom:'0',zIndex:'99',backgroundColor: '#283642'}}>
            <div className="card p-0 text-light text-center bg-transparent rounded-0">
                <div className="card-footer px-0 py-3 d-flex justify-content-between">
                    ...
                    <a className="nav nav-link text-white p-0" href='/#'>About Us!</a>
